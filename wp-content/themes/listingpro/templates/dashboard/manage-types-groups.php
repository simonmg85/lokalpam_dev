                        ...
                        <div class="lp-coupon-box-row">
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 clarfix">
                                    ...
                                    <button data-uid="1" class="lp-coupns-btns pull-right manage-type-group-form save-new-type"><?php echo esc_html__('save', 'listingpro'); ?></button>
                                </div>
                            </div>
                        </div>
                    </form>
                        ...
                        <div class="lp-coupon-box-row">
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 clarfix">
                                    ...
                                    <button data-uid="1" class="lp-coupns-btns pull-right manage-type-group-form save-new-group"><?php echo esc_html__('save', 'listingpro'); ?></button>
                                </div>
                            </div>
                        </div>
                    </form>
