...
//                                                    the_post_thumbnail('full');
                                                ...
                                                if ($blog_view == 'list_view') {
                                                    echo '<img src="' . esc_html__('https://placeholdit.imgix.net/~text?txtsize=33&w=305&h=200', 'listingpro') . '" alt="">';
                                                } else {
                            ...
                            <div class="lp-blog-grid-box-thumb">
                                <a href="<?php the_permalink(); ?>">
                                    ...
                                    if ( has_post_thumbnail() ) {
                                        ...
                                        if( $blog_view == 'list_view2' )
                                        {
                                            echo '<img src="'.esc_html__('https://placeholdit.imgix.net/~text?txtsize=33&w=770&h=460', 'listingpro').'" alt="">';
                                        }
                                        else
                                        {
                                            echo '<img src="'.esc_html__('https://placeholdit.imgix.net/~text?txtsize=33&w=368&h=220', 'listingpro').'" alt="">';
                                        }
                            ...
                            <div class="lp-blog-grid-box-thumb">
                                <a href="<?php the_permalink(); ?>">
                                    ...
                                    if ( has_post_thumbnail() ) {
                                        ...
                                        {
                                            echo '<img src="'.esc_html__('https://placeholdit.imgix.net/~text?txtsize=33&w=270&h=270', 'listingpro').'" alt="">';
                                        }
