                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="lp-event-viewall-attende">
                                <h4><?php echo esc_html__('Attendees', 'listingpro' ); ?> <?php echo esc_html__('(', 'listingpro' ); ?><?php echo $attendies_count; ?><?php echo esc_html__(')', 'listingpro' ); ?></h4>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="lp-event-detail-sidebar-area">
                                <div class="event-total-going"><span><strong><?php echo esc_html__( 'Are You going ?', 'listingpro' ); ?></strong><?php echo $attendies_count; ?> <?php echo esc_html__( 'going', 'listingpro' ); ?></span></div>
