...
use Inpsyde\Lib\PayPal\Common\PayPalResourceModel;
use Inpsyde\Lib\PayPal\Core\PayPalConstants;
use Inpsyde\Lib\PayPal\Validation\ArgumentValidator;
 ...
 * @property \Inpsyde\Lib\PayPal\Api\Payer payer
 * @property \Inpsyde\Lib\PayPal\Api\Transaction[] transactions
 * @property string state
 * @property string experience_profile_id
 * @property string note_to_payer
 * @property \Inpsyde\Lib\PayPal\Api\Payee $payee
 * @property \Inpsyde\Lib\PayPal\Api\RedirectUrls redirect_urls
...
class Payment extends PayPalResourceModel
{
     ...
     *
     * @param \Inpsyde\Lib\PayPal\Api\Payer $payer
     * 
     * @return $this
     */
     ...
     * Source of the funds for this payment represented by a PayPal account or a direct credit card.
     *
     * @return \Inpsyde\Lib\PayPal\Api\Payer
     */
     ...
     * @param \Inpsyde\Lib\PayPal\Api\PotentialPayerInfo $potential_payer_info
     * 
     * @return $this
     */
     ...
     * Information that the merchant knows about the payer.  This information is not definitive and only serves as a hint to the UI or any pre-processing logic.
     * @deprecated Not publicly available
     * @return \Inpsyde\Lib\PayPal\Api\PotentialPayerInfo
     */
     ...
     * @param \Inpsyde\Lib\PayPal\Api\Payee $payee
     * 
     * @return $this
     */
    ...
    /**
     * Receiver of funds for this payment.
     * @return \Inpsyde\Lib\PayPal\Api\Payee
     */
     ...
     *
     * @param \Inpsyde\Lib\PayPal\Api\Transaction[] $transactions
     * 
     * @return $this
     */
     ...
     * Transactional details including the amount and item details.
     *
     * @return \Inpsyde\Lib\PayPal\Api\Transaction[]
     */
     ...
     *
     * @param \Inpsyde\Lib\PayPal\Api\Transaction $transaction
     * @return $this
     */
     ...
     * @deprecated Not publicly available
     * @param \Inpsyde\Lib\PayPal\Api\Error[] $failed_transactions
     * 
     * @return $this
     */
     ...
     * Applicable for advanced payments like multi seller payment (MSP) to support partial failures
     * @deprecated Not publicly available
     * @return \Inpsyde\Lib\PayPal\Api\Error[]
     */
     ...
     * @deprecated Not publicly available
     * @param \Inpsyde\Lib\PayPal\Api\Error $error
     * @return $this
     */
     ...
     * @deprecated Not publicly available
     * @param \Inpsyde\Lib\PayPal\Api\CreditFinancingOffered $credit_financing_offered
     * 
     * @return $this
     */
     ...
     * Credit financing offered to payer on PayPal side. Returned in payment after payer opts-in
     * @deprecated Not publicly available
     * @return \Inpsyde\Lib\PayPal\Api\CreditFinancingOffered
     */
     ...
     * @deprecated Not publicly available
     * @param \Inpsyde\Lib\PayPal\Api\PaymentInstruction $payment_instruction
     * 
     * @return $this
     */
     ...
     *
     * @param \Inpsyde\Lib\PayPal\Api\RedirectUrls $redirect_urls
     * 
     * @return $this
     */
     ...
     * Set of redirect URLs you provide only for PayPal-based payments.
     *
     * @return \Inpsyde\Lib\PayPal\Api\RedirectUrls
     */
