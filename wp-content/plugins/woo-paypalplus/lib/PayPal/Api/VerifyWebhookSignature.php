...
use Inpsyde\Lib\PayPal\Api\VerifyWebhookSignatureResponse;
 ...
 * @property \Inpsyde\Lib\PayPal\Api\WebhookEvent webhook_event
 */
class VerifyWebhookSignature extends PayPalResourceModel
{
     ...
     *
     * @param \Inpsyde\Lib\PayPal\Api\WebhookEvent $webhook_event
     * 
     * @return $this
     */
     ...
     * The webhook notification, which is the content of the HTTP `POST` request body.
     *
     * @return \Inpsyde\Lib\PayPal\Api\WebhookEvent
     */
