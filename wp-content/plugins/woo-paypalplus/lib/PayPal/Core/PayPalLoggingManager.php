...
namespace Inpsyde\Lib\PayPal\Core;
...
class PayPalLoggingManager
{
    ...
    private function __construct($loggerName)
    {
        ...
        $factory = array_key_exists('log.AdapterFactory', $config) && in_array('Inpsyde\Lib\PayPal\Log\PayPalLogFactory', class_implements($config['log.AdapterFactory'])) ? $config['log.AdapterFactory'] : '\Inpsyde\Lib\PayPal\Log\PayPalDefaultLogFactory';
