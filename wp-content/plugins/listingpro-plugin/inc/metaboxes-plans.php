<?php
	...
	if($plans_by_cat=='yes'){
		...
		function plan_cats_callback( $post ) {
			...
			$parent_cats = lp_get_parent_cats_array(false);
	...
	function plan_contact_box() {
		...
		echo '">';
		echo __('<label for="contact_show">  Check it if you want to allow user to show his <b>contact information</b></label>', 'listingpro-plugin');
		...
		echo __('<label for="contact_show_hide">  check this to Hide option text on pricing plan page</label><br/>', 'listingpro-plugin');
		?>
			</div>
			<br clear="all" />
		</div>
		...
		echo '">';
		echo __('<label for="map_show">  Check it if you want to allow user to show his <b>Google map</b></label>', 'listingpro-plugin');
		...
		echo __('<label for="map_show_hide">  check this to Hide option text on pricing plan page</label><br/>', 'listingpro-plugin');
		?>
			</div>
			<br clear="all" />
		</div>
		...
		echo '">';
		echo __('<label for="video_show">  Check it if you want to allow user to show his Ad <b>video</b></label>', 'listingpro-plugin');
		...
		echo __('<label for="video_show_hide">  check this to Hide option text on pricing plan page</label><br/>', 'listingpro-plugin');
		?>
			</div>
			<br clear="all" />
		</div>
		...
		echo '">';
		echo __('<label for="gallery_show">  Check it if you want to allow user to show his <b>Gallery</b></label>', 'listingpro-plugin');
		...
		echo __('<label for="gall_show_hide">  check this to Hide option text on pricing plan page</label><br/>', 'listingpro-plugin');
		?>
		</div>
			<br clear="all" />
		</div>
		...
		<div style="border-bottom: 1px solid #ccc;padding: 10px 0px;">
			<div style="width:60%;float:left">
				...
				<label for="listingproc_tagline"> <?php echo __('Check it if you want to allow user to add <b>Tagline</b>', 'listingpro-plugin'); ?></label>
				<?php
			...
			<div style="width:40%;float:left">
				...
				echo __('<label for="tagline_show_hide">  check this to Hide option text on pricing plan page</label><br/>', 'listingpro-plugin');
				?>
			</div>
			<br clear="all" />
		</div>
		...
		<label for="listingproc_location"> <?php echo __('Check it if you want to allow user to add <b>Location.</b>', 'listingpro-plugin'); ?></label>
		<?php
		...
		echo __('<label for="location_show_hide">  check this to Hide option text on pricing plan page</label><br/>', 'listingpro-plugin');
		?>
			</div>
			<br clear="all" />
		</div>
		...
		<label for="listingproc_website"><?php echo __('Check it if you want to allow user to add <b>Website.</b>', 'listingpro-plugin'); ?></label>
		<?php
		...
		echo __('<label for="website_show_hide">  check this to Hide option text on pricing plan page</label><br/>', 'listingpro-plugin');
		?>
			</div>
			<br clear="all" />
		</div>
		...
		<label for="listingproc_social"><?php echo __('Check it if you want to allow user to add <b>Social Media links.</b>', 'listingpro-plugin'); ?></label>
		<?php
		...
		echo __('<label for="social_show_hide">  check this to Hide option text on pricing plan page</label><br/>', 'listingpro-plugin');
		?>
			</div>
			<br clear="all" />
		</div>
		...
		<div style="border-bottom: 1px solid #ccc;padding: 10px 0px;">
			<div style="width:60%;float:left">
				...
				<label for="listingproc_faq"><?php echo __('Check it if you want to allow user to add <b>FAQs list.</b>', 'listingpro-plugin'); ?></label>
			</div>
			<?php
			...
			<div style="width:40%;float:left">
				...
				echo __('<label for="faqs_show_hide">  check this to Hide option text on pricing plan page</label><br/>', 'listingpro-plugin');
				?>
			</div>
			<br clear="all" />
		</div>
		...
		<label for="listingproc_price"><?php echo __('Check it if you want to allow user to add <b>Price Range.</b>', 'listingpro-plugin'); ?></label>
		<?php
		...
		echo __('<label for="price_show_hide">  check this to Hide option text on pricing plan page</label><br/>', 'listingpro-plugin');
		?>
			</div>
			<br clear="all" />
		</div>
		...
		<label for="listingproc_tag_key"><?php echo __('Check it if you want to allow user to add <b>Tags or Keywords.</b>', 'listingpro-plugin'); ?></label>
		<?php
		...
		echo __('<label for="tags_show_hide">  check this to Hide option text on pricing plan page</label><br/>', 'listingpro-plugin');
		?>
			</div>
			<br clear="all" />
		</div>
		...
		<label for="listingproc_bhours"><?php echo __('Check it if you want to allow user to add <b>Business Hours.</b>', 'listingpro-plugin'); ?></label>
		...
		echo __('<label for="bhours_show_hide">  check this to Hide option text on pricing plan page</label><br/>', 'listingpro-plugin');
		?>
			</div>
			<br clear="all" />
		</div>
		...
		<label for="listingproc_plan_reservera"><?php echo __('Check it if you want to allow this plan for <b>Reserva Booking.</b>', 'listingpro-plugin'); ?></label>
		...
		echo __('<label for="reserva_show_hide">  check this to Hide option text on pricing plan page</label><br/>', 'listingpro-plugin');
		?>
			</div>
			<br clear="all" />
		</div>
		...
		<label for="listingproc_plan_timekit"><?php echo __('Check it if you want to allow this plan for <b>Timekit Booking.</b>', 'listingpro-plugin'); ?></label>
		...
		echo __('<label for="timekit_show_hide">  check this to Hide option text on pricing plan page</label><br/>', 'listingpro-plugin');
		?>
			</div>
			<br clear="all" />
		</div>
		...
		<label for="listingproc_plan_menu"><?php echo __('Check it if you want to allow user to add <b>Menu.</b>', 'listingpro-plugin'); ?></label>
		...
		echo __('<label for="menu_show_hide">  check this to Hide option text on pricing plan page</label><br/>', 'listingpro-plugin');
		?>
			</div>
			<br clear="all" />
		</div>
		...
		<label for="listingproc_plan_announcment"><?php echo __('Check it if you want to allow user to add <b>Announcement.</b>', 'listingpro-plugin'); ?></label>
		...
		echo __('<label for="announcment_show_hide">  check this to Hide option text on pricing plan page</label><br/>', 'listingpro-plugin');
		?>
			</div>
			<br clear="all" />
		</div>
		...
		<label for="listingproc_plan_deals"><?php echo __('Check it if you want to allow user to add <b>Deals, Offers, Discounts.</b>', 'listingpro-plugin'); ?></label>
		...
		echo __('<label for="deals_show_hide">  check this to Hide option text on pricing plan page</label><br/>', 'listingpro-plugin');
		?>
			</div>
			<br clear="all" />
		</div>
		...
		<label for="listingproc_plan_campaigns"><?php echo __('Check it if you want this plan to hide <b>competitor campaigns</b> on Listing Detail Page', 'listingpro-plugin'); ?></label>
		<?php
		...
		echo __('<label for="metacampaign_show_hide">  check this to Hide option text on pricing plan page</label><br/>', 'listingpro-plugin');
		?>
			</div>
			<br clear="all" />
		</div>
		...
		<label for="lp_featured_imageplan"><?php echo __('Check it if you want this plan to hide <b>featured image</b> on Listing Detail Page', 'listingpro-plugin'); ?></label>
		<?php
		...
		echo __('<label for="featimg_show_hide">  check this to Hide option text on pricing plan page</label><br/>', 'listingpro-plugin');
		?>
			</div>
			<br clear="all" />
		</div>
		...
		echo __('<label for="events_show_hide">  check this to Hide option text on pricing plan page</label><br/>', 'listingpro-plugin');
		?>
			</div>
			<br clear="all" />
		</div>
