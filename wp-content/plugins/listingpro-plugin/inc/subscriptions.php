            ...
            <div class="listingpro_coupon_table">
                <table class="table wp-list-table widefat fixed striped posts">
                    ...
                    <tr>
                        ...
                        <th class="manage-column column-tags"><?php echo esc_html__('Total(inc.Tax)', 'listingpro-plugin'); ?></th>
                            ...
                            foreach($userSubscriptions as $subscription){
                                try {
                                    ...
                                    <tr>
                                        ...
                                        <td><input class="alert alert-success" type="button" name="lp_delte_coupon_submit" value="<?php echo esc_html__('Active', 'listingpro-plugin'); ?>" ></td>
