<?php echo apply_filters( 'atospp_tos_before_heading', '' ); ?>
    <h2 id='atospp-terms' class='auto-tos-pp tosheading'><?php echo $atospp_tos_heading; ?>:</h2>
<?php echo apply_filters( 'atospp_tos_after_heading', '' ); ?>
    <p>The following terms and conditions govern all use of the <?php echo $atospp_domainname; ?> website and all
        content,
        services and products available at or through the website (taken together, the Website). The Website is owned
        and operated by <?php echo $atospp_namefull; ?> (&quot;<?php echo $atospp_name; ?>&quot;). The Website is
        ...
        limitation, <?php echo $atospp_namepossessive; ?> <?php echo $atospp_pp_heading; ?>) and procedures that may be
        published from time to time on this Site by <?php echo $atospp_name; ?> (collectively, the &quot;Agreement&quot;).</p>
    <p>Please read this Agreement carefully before accessing or using the Website. By accessing or using any part of the
        ...
        terms and conditions are considered an offer by <?php echo $atospp_name; ?>, acceptance is expressly limited to
        these terms. The Website is available only to individuals who are at least <?php echo $atospp_minage; ?> years
        old.</p>
    <ol>
        <li><strong>Your <?php echo $atospp_domainname; ?> Account and Site.</strong> If you create a blog/site on the
            ...
            including in a manner intended to trade on the name or reputation of others, and <?php echo $atospp_name; ?>
            may change or remove any description or keyword that it considers inappropriate or unlawful, or otherwise
            likely to cause <?php echo $atospp_name; ?> liability. You must immediately
            notify <?php echo $atospp_name; ?> of any unauthorized uses of your blog, your account or any other breaches
            of security. <?php echo $atospp_name; ?> will not be liable for any acts or omissions by You, including any
        ...
        <li><strong>Responsibility of Contributors.</strong> If you operate a blog, comment on a blog, post material to
            ...
            <ul>
                ...
                <li>you have, in the case of Content that includes computer code, accurately categorized and/or
					...
					<?php echo $atospp_name; ?> or otherwise.
                </li>
            </ul>
            <p>By submitting Content to <?php echo $atospp_name; ?> for inclusion on your Website, you
                grant <?php echo $atospp_name; ?> a world-wide, royalty-free, and non-exclusive license to reproduce,
                modify, adapt and publish the Content solely for the purpose of displaying, distributing and promoting
                your blog. If you delete Content, <?php echo $atospp_name; ?> will use reasonable efforts to remove it
                from the Website, but you acknowledge that caching or references to the Content may not be made
                immediately unavailable.</p>
            <p>Without limiting any of those representations or warranties, <?php echo $atospp_name; ?> has the right
                (though not the obligation) to, in <?php echo $atospp_namepossessive; ?> sole discretion (i) refuse or
                remove any content that, in <?php echo $atospp_namepossessive; ?> reasonable opinion, violates
                any <?php echo $atospp_name; ?> policy or is in any way harmful or objectionable, or (ii) terminate or
                deny access to and use of the Website to any individual or entity for any reason,
                in <?php echo $atospp_namepossessive; ?> sole discretion. <?php echo $atospp_name; ?> will have no
        ...
        <li><strong>Payment and Renewal.</strong>
            <ul>
                <li><strong>General Terms.</strong><br>
                    By selecting a product or service, you agree to pay <?php echo $atospp_name; ?> the one-time and/or
                    monthly or
                ...
                <li><strong>Automatic Renewal. </strong><br>
                    Unless you notify <?php echo $atospp_name; ?> before the end of the applicable subscription period
                    that you want
                    ...
                    at any time by submitting your request to <?php echo $atospp_name; ?> in writing.
                </li>
            </ul>
        </li>
        <li><strong>Services.</strong>
            <ul>
                <li><strong>Fees; Payment. </strong>By signing up for a Services account you agree to
                    pay <?php echo $atospp_name; ?>
                    the applicable setup fees and recurring fees. Applicable fees will be invoiced starting from the day
                    your services are established and in advance of using such services. <?php echo $atospp_name; ?>
                    reserves the
                    right to change the payment terms and fees
                    upon <?php echo $atospp_time_feesnotifications; ?>
                    prior written notice to you. Services can be canceled by you at anytime on
					<?php echo $atospp_time_feesnotifications; ?> written notice
                    to <?php echo $atospp_name; ?>.
                </li>
                <li><strong>Support.</strong> If your service includes access to priority email support. &quot;Email
                    ...
                    time (with reasonable efforts by <?php echo $atospp_name; ?> to respond within
					<?php echo $atospp_time_replytopriorityemail; ?>) concerning the use of the VIP Services.
                    &quot;Priority&quot;
                    means that support takes priority over support for users of the standard or
                    free <?php echo $atospp_domainname; ?>
                    services. All support will be provided in accordance
                    with <?php echo $atospp_name; ?> standard services practices,
                    procedures and policies.
                </li>
            </ul>
        <li><strong>Responsibility of Website Visitors.</strong> <?php echo $atospp_name; ?> has not reviewed, and
            cannot review, all
            of the material, including computer software, posted to the Website, and cannot therefore be responsible for
            that material's content, use or effects. By operating the Website, <?php echo $atospp_name; ?> does not
            represent or imply
            ...
            conditions, stated or unstated. <?php echo $atospp_name; ?> disclaims any responsibility for any harm
            resulting from the
        ...
        <li><strong>Content Posted on Other Websites.</strong> We have not reviewed, and cannot review, all of the
			...
			<?php echo $atospp_domainname; ?> links, and that link to <?php echo $atospp_domainname; ?>.
			<?php echo $atospp_name; ?> does not have any control over those non-<?php echo $atospp_name; ?> websites
            and webpages, and is not responsible for their contents or their use. By linking to a
            non-<?php echo $atospp_name; ?> website or webpage, <?php echo $atospp_name; ?> does not represent or imply
            ...
            content. <?php echo $atospp_name; ?> disclaims any responsibility for any harm resulting from your use of
            non-<?php echo $atospp_name; ?> websites and webpages.
        </li>
        <li><strong>Copyright Infringement and DMCA Policy.</strong> As <?php echo $atospp_name; ?> asks others to
            respect its
            intellectual property rights, it respects the intellectual property rights of others. If you believe that
            material located on or linked to by <?php echo $atospp_domainname; ?> violates your copyright, you are
            encouraged to notify <?php echo $atospp_name; ?> in accordance with <?php
			if ( ! empty( $atospp_dmcanoticeurl ) ) {
				echo '<a href="' . $atospp_dmcanoticeurl . '">';
			} else {
				echo $atospp_namepossessive;
			}
			?> Digital Millennium Copyright Act (&quot;DMCA&quot;) Policy<?php
			if ( ! empty( $atospp_dmcanoticeurl ) ) {
				echo '</a>';
			} ?>.
			<?php echo $atospp_name; ?> will respond to all such notices, including as required or appropriate by
            removing the infringing material or disabling all links to the infringing
            material. <?php echo $atospp_name; ?> will terminate a visitor's access to and use of the Website if, under
            appropriate circumstances, the visitor is determined to be a repeat infringer of the copyrights or other
            intellectual property rights of <?php echo $atospp_name; ?> or others. In the case of such
            termination, <?php echo $atospp_name; ?> will have no obligation to provide a refund of any amounts
            previously paid to <?php echo $atospp_name; ?>.
        </li>
        <li><strong>Intellectual Property.</strong> This Agreement does not transfer from <?php echo $atospp_name; ?>
            to you any <?php echo $atospp_name; ?> or third party intellectual property, and all right, title and
            interest in and to such property will remain (as between the parties) solely
            with <?php echo $atospp_name; ?>. <?php echo $atospp_name; ?>, <?php echo $atospp_domainname; ?>,
            the <?php echo $atospp_domainname; ?> logo, and all other trademarks, service marks, graphics and logos used
            in connection with <?php echo $atospp_domainname; ?>, or the Website are trademarks or registered trademarks
            of <?php echo $atospp_name; ?> or <?php echo $atospp_namepossessive; ?> licensors. Other trademarks, service
            ...
            any <?php echo $atospp_name; ?> or third-party trademarks.
        </li>
        <li><strong>Advertisements.</strong> <?php echo $atospp_name; ?> reserves the right to display advertisements
            on your blog unless you have purchased an ad-free account.
        </li>
        <li><strong>Attribution.</strong> <?php echo $atospp_name; ?> reserves the right to display attribution links
            such as 'Blog at <?php echo $atospp_domainname; ?>,' theme author, and font attribution in your blog footer
            or toolbar.
        </li>
        ...
        <li><strong>Changes. </strong><?php echo $atospp_name; ?> reserves the right, at its sole discretion, to modify
            ...
            acceptance of those changes. <?php echo $atospp_name; ?> may also, in the future, offer new services and/or
            features
        ...
        <li><strong>Termination. </strong><?php echo $atospp_name; ?> may terminate your access to all or any part of
            the Website at
            any time, with or without cause, with or without notice, effective immediately. If you wish to terminate
            this Agreement or your <?php echo $atospp_domainname; ?> account (if you have one), you may simply
            discontinue
            using the
            Website. Notwithstanding the foregoing, if you have a paid services account, such account can only be
            terminated by <?php echo $atospp_name; ?> if you materially breach this Agreement and fail to cure such
            breach within
			<?php echo $atospp_time_feesnotifications; ?>
            from <?php echo $atospp_namepossessive; ?> notice to you thereof;
            provided that, <?php echo $atospp_name; ?> can terminate the Website immediately as part of a general shut
            down of our
        ...
        <li class='important'><strong>Disclaimer of Warranties.</strong> The Website is provided &quot;as is&quot;.
			<?php echo $atospp_name; ?> and its suppliers and licensors hereby disclaim all warranties of any kind,
            express or
            implied, including, without limitation, the warranties of merchantability, fitness for a particular purpose
            and non-infringement. Neither <?php echo $atospp_name; ?> nor its suppliers and licensors, makes any
            warranty that the
        ...
        <li class='important'><strong>Limitation of Liability.</strong> In no event will <?php echo $atospp_name; ?>,
            or its suppliers
            ...
            to <?php echo $atospp_name; ?> under this agreement during
            the <?php echo $atospp_time_determiningmaxdamages; ?> period prior to the cause of
            action. <?php echo $atospp_name; ?> shall have no liability for any failure or delay due to matters beyond
        ...
        <li><strong>General Representation and Warranty.</strong> You represent and warrant that (i) your use of the
            ...
            the <?php echo $atospp_name; ?> <?php echo $atospp_pp_heading; ?>, with this Agreement
        ...
        <li><strong>Indemnification.</strong> You agree to indemnify and hold harmless <?php echo $atospp_name; ?>, its
            contractors,
        ...
        <li><strong>Miscellaneous.</strong> This Agreement constitutes the entire agreement
            between <?php echo $atospp_name; ?> and
            you concerning the subject matter hereof, and they may only be modified by a written amendment signed by an
            authorized executive of <?php echo $atospp_name; ?>, or by the posting by <?php echo $atospp_name; ?> of a
            ...
            will be governed by the laws of the <?php echo $atospp_venue; ?>, excluding its conflict of law provisions,
            and the proper
            venue for any disputes arising out of or relating to any of the same will be the state and federal courts
            located in <?php echo $atospp_courtlocation; ?>. Except for claims for injunctive or equitable relief or
            claims regarding
			...
			<?php echo $atospp_arbitrationlocation; ?>, in the English language and the arbitral decision may be
            enforced
            in any court.
			...
			<?php echo $atospp_name; ?> may assign its rights under this Agreement without condition. This Agreement
            will be binding
            upon and will inure to the benefit of the parties, their successors and permitted assigns.
        </li>
    </ol>
<?php echo apply_filters( 'atospp_tos_after_end', '' ); ?>