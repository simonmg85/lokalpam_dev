	...
	public function register( $settings ) {
		...
		$desc = sprintf(
			wp_kses(
				...
				__( 'Keys can be found in your Stripe account dashboard. For more information see our <a href="%s" target="_blank" rel="noopener noreferrer">Stripe documentation</a>.', 'wpforms-stripe' ),
				array(
					'a' => array(
						'href'   => array(),
						'target' => array(),
